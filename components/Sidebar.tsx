  ...
  return (
    <div>
      ...
      <h3 className="my-4 text-3xl font-medium tracking-wider font-poppins">
        <span className="text-green"> Stanisław Marciniak</span>
      </h3>
      <p className="px-2 py-1 my-3 rounded-full bg-green-150 dark:bg-dark-200 dark:bg-black-500">
        Aspiring Web Developer
      </p>
      <a
        className="flex items-center justify-center px-2 py-1 my-3 bg-green-200 rounded-full dark:bg-dark-200 dark:bg-black-500 "
        href="/resume.pdf"
      ...
      <div
        className="py-4 my-5 bg-green-200 dark:bg-dark-200 dark:bg-black-500"
      ...
      <button
        className="w-8/12 px-5 py-2 my-2 text-white rounded-full bg-gradient-to-r from-green to-green-500 focus:outline-none hover:scale-105"
